...
def get_lls(texts):
    ...
    if not args.openai_model:
        ...
        # use GPT2_TOKENIZER to get the total number of tokens
...
def save_roc_curves(experiments):
    ...
    for experiment, color in zip(experiments, COLORS):
        ...
        # Print the roc_auc for this experiment
...
def get_perturbation_results(span_length=10, n_perturbations=1, n_samples=500):
    ...
    perturb_fn = functools.partial(
        perturb_texts, span_length=span_length, pct=args.pct_words_masked
    )
...
def run_perturbation_experiment(
    results, criterion, span_length=10, n_perturbations=1, n_samples=500
):
...
if __name__ == "__main__":
    ...
    data_loader = DetectionDataset(
        ...
        human_source=args.human_location,
